...
int main()
{
	...
	cout<<"Resultado de la suma es:"<<sum<<endl;
	cout<<"Resultado de la resta es:"<<rest<<endl;
	cout<<"Resultado de la multiplicacion es:"<<mul<<endl;
	cout<<"Resultado de la division es:"<<div<<endl; 
    return 0;
	}
